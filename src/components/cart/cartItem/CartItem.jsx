...
const CartItem = (props) => {
  ...
  const axiosPeticionById = async () => {
    ...
    let st = (await axios.get(`https://back2demo2-production.up.railway.app/home/${item.id}`));
  ...
  const mas = async (e) => {
    ...
    let post = await axios.get(`https://back2demo2-production.up.railway.app/home/${props.item.id}`)
